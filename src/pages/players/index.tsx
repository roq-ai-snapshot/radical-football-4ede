...
function PlayerListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<PlayerInterface[]>(
    ...
    () =>
      getPlayers({
        relations: ['user_player_user_idTouser', 'user_player_coach_idTouser', 'note.count', 'parent.count'],
      }),
  );
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    <Td>{record.name}</Td>
                    <Td>{record.status}</Td>
                    {hasAccess('user_player_user_id_touser', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                    ...
                    {hasAccess('user_player_coach_id_touser', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
